...
> هذا الملف هو **العقد النهائي** بين الفرونت اند (TanStack Start + React + TS) والباك اند المستضاف على `https://saba-design.com/api`. كل ما هو في الموقع يتم استهلاكه عبر الـ API بدون أي قاعدة بيانات محلية ولا Supabase ولا Edge Functions. لو غيّرت اسم endpoint أو حقل واحد، الفرونت سيكسر.
