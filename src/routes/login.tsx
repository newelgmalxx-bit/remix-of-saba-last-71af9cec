        ...
        <div className="flex items-center px-6 py-10 sm:px-12 lg:py-14">
          <div className="mx-auto w-full max-w-md">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="relative flex items-center justify-center overflow-hidden rounded-xl border border-border bg-white transition hover:border-primary hover:bg-secondary/40">
