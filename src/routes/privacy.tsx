      ...
      <main className="flex-1">
        <section className="relative overflow-hidden bg-gradient-to-l from-primary-dark via-primary to-primary-dark text-white">
          <div className="mx-auto max-w-5xl px-4 py-16 text-center sm:px-6 lg:px-8">
            ...
            <h1 className="text-3xl font-extrabold sm:text-4xl">{t("legal.privacy.title")}</h1>
            <p className="mx-auto mt-3 max-w-2xl text-sm text-white/85">{t("legal.privacy.subtitle")}</p>
