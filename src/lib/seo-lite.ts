export const SITE = {
  ...
  logo: "https://saba-design.com/logo.webp",
  ogImage: "https://saba-design.com/logo.webp",
  twitter: "@sabadesign",
  locale: "ar_SA",
  phone: "+966501234567",
...
export function abs(url: string | undefined) {
...
export function organizationJsonLd() {
  return {
    ...
    sameAs: [
      ...
      "https://www.tiktok.com/@sabadesign",
      "https://www.snapchat.com/add/sabadesign",
    ],
  };
}
...
export function localBusinessJsonLd() {
  return {
    ...
    email: SITE.email,
    priceRange: "$$",
    address: { "@type": "PostalAddress", addressCountry: "SA", addressLocality: "Riyadh", addressRegion: "Riyadh" },
